  ...
  <main>
    ...
    >
      ...
      <v-sheet
        tile
        color="transparent"
        class="py-3 mt-12 mb-5 d-flex justify-center"
      >
        <nuxt-link to="/">
      ...
      <v-list dark shaped dense>
        ...
        <template>
          <v-list-item nuxt to="/shop/all-products-new" color="#F9A825">
            <template>
              <v-list-item-action>
        ...
        <template>
          <v-list-item
            href="https://app.paygodash.com/firstelec"
            color="primary"
          >
            <template>
              <v-list-item-action>
    ...
    <!-- START OF TOOLBAR -->
    <v-app-bar
      :class="$vuetify.breakpoint.lgAndUp ? 'px-12' : ''"
      flat
      color="transparent"
      height="135"
      absolute
      ...
      >
        ...
        >
          ...
          >
            ...
            <CurrencyNav v-if="this.$vuetify.breakpoint.mdOnly" />

            <v-badge
              color="red"
              class="secondary--text mx-4"
              :content="cart.length ? cart.length : '0'"
            >
              <v-icon @click="$router.push('/shop/cart')" color="white"
                >mdi-cart</v-icon
              >
            </v-badge>

            <v-app-bar-nav-icon
              @click.stop="sideNav.model = !sideNav.model"
              class="primary--text"
            ></v-app-bar-nav-icon>
          </div>
        </div>
        ...
        >
          ...
          <v-menu open-on-hover bottom center offset-y>
            ...
            <v-sheet class="py-3">
              <nuxt-link
                to="/power"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.power') }}</nuxt-link
              >

              <nuxt-link
                to="/automation"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.automation') }}</nuxt-link
              >

              <nuxt-link
                to="/ev-workshop-services"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.ev') }}</nuxt-link
              >
            </v-sheet>
          </v-menu>
          ...
          <v-menu open-on-hover bottom center offset-y>
            ...
            <v-sheet class="py-3">
              <nuxt-link
                ...
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.power_assessment') }}</nuxt-link
              >

              <nuxt-link
                to="/services/#energy-audit"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.energy_audit') }}</nuxt-link
              >

              <nuxt-link
                to="/services/#solar-equipment-installation"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.equipment_installation') }}</nuxt-link
              >

              <nuxt-link
                to="/services/#electric-motor-installation"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.motor_installation') }}</nuxt-link
              >

              <nuxt-link
                to="/services/#engineering-consultation"
                class="py-2 px-5 menu__item d-flex menu__item__inner body-2 font-weight-bold text-no-wrap"
                >{{ $t('header.consultation') }}</nuxt-link
              >
            </v-sheet>
          </v-menu>
          ...
          <v-btn
            ...
            href="https://app.paygodash.com/firstelec"
            color="primary"
            class="mr-6 secondary--text shop__btn font-weight-bold font__13"
            >PAYGO</v-btn
          >
          <v-btn
            depressed
          ...
          <v-btn
            ...
            to="/shop"
            color="red"
            class="mr-6 shop__btn font-weight-bold font__13"
            >{{ $t('header.shop') }}</v-btn
          >
...
import ToolbarExt from '@/components/navigation/Shop-Toolbar-Ext.vue'
